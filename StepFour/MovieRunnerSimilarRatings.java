...
public class MovieRunnerSimilarRatings {    
    ...
    public void printAverageRatingsByMinutes(){
        ...
        int noRatings = 5; //must have at least minNoRatings and be sorted by avg
        int min = 105;
        int max = 135;
        //int minMinutes = 110;
        //int maxMinutes = 170;
        ...
        System.out.println("Found " + ratings.size() + " movies with " + noRatings 
            + " rating(s), and runtime between" + min + " - " + max + "minutes");
    }
    ...
    public void printAverageRatingsByYearAfter(){
        ...
        //Criteria for filters
        int noRatings = 20; //must have at least minNoRatings and be sorted by avg
        int year = 2000;
        //int minMinutes = 110;
        //int maxMinutes = 170;
        //String directors = "Charles Chaplin,Michael Mann,Spike Jonze";
